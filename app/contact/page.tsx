        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              together to bring your ideas to life. I'm always excited to take
              on new challenges and collaborate with amazing people.
            </p>
          </motion.div>
            ...
            >
              <div>
                ...
                <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                  ...
                  creative projects, or simply connecting with fellow developers
                  and designers. Whether you have a specific project in mind or
                  ...
                  {[
                    {
                      ...
                      answer:
                        "Project timelines vary based on scope, but most projects range from 2-8 weeks.",
                    },
                    {
                    ...
                    },
                    {
                      ...
                      answer:
                        "I prefer email for initial contact, then video calls for project discussions.",
                    },
                  ].map((faq, index) => (
                    <motion.div
                      key={index}
                ...
                <CardContent className="p-0">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <Button
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full py-3 text-lg font-semibold btn-navy"
                    >
                      {isSubmitting ? (
