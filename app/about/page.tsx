        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              <strong> Informatics Engineering</strong>. With a strong
              foundation in both front-end and back-end development, I enjoy
              building modern, scalable web applications that not only work well
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  development began in 2022, driven by a deep curiosity about
                  how websites and digital products are created.
                </p>
                <p>
                  As a student of Informatics Engineering at{" "}
                  <strong>Universitas Dipa Makassar</strong>, I've had the
                  opportunity to deepen my understanding of software
                  development, from algorithms and data structures to back-end
                ...
                <p>
                  ...
                  community through online platforms and mentoring others who
                  are just starting out in tech.
                </p>
              </div>
            </motion.div>
